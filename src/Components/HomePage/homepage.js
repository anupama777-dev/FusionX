    ...
    <div className="home_page">
      ...
      <div className="about-us">
        ...
        <Text className="subtitle-1">
          ...
          small businesses, startups, and individuals in the ever-evolving
          online market. Our platform is designed to provide users with a
          seamless and user-friendly experience, enabling them to create their
          own stores and amplify their sales potential.
          <br />
          <br />
          At FusionX, we understand the importance of attention to detail, which
          is why our features allow users to effortlessly add products with
          comprehensive descriptions and captivating visuals. With customizable
          themes, colors, and fonts, users can tailor their stores to reflect
          their unique brand identities, standing out in the crowded digital
          landscape.
          <br />
          <br />
          Moreover, our hosting capabilities ensure that users can easily share
          their stores with the world, reaching their target audience with ease.
          To further enhance the customer experience, our dedicated chatbot
          feature is on standby to promptly address any inquiries, facilitating
          a smooth and interactive shopping journey. Join us at FusionX and
      ...
      <div className="contact-us">
        <div className="contact-us1">
          ...
          <Text className="contact-us-subtitle">
            Email ID : FusionX@gmail.com
            <br />
        ...
        <div className="reach-us">
          ...
          <Text className="contact-us-subtitle">
            <Icon as={IoLogoFacebook} width="21px" height="21px" /> FusionX
            <br />
            <Icon as={IoLogoInstagram} width="21px" height="21px" /> FusionX
            <br />
            <Icon as={IoLogoLinkedin} width="21px" height="21px" /> FusionX
          </Text>
        </div>
      </div>
    </div>
