...
function TemplateHomePage() {
  ...
  return (
    <div
      className={
        selectedColor === "blue"
          ? "template-home_page-blue"
          : selectedColor === "red"
          ? "template-home_page-red"
          : selectedColor === "green"
          ? "template-home_page-green"
          : selectedColor === "yellow"
          ? "template-home_page-yellow"
          : selectedColor === "pink"
          ? "template-home_page-pink"
          : selectedColor === "purple"
          ? "template-home_page-purple"
          : selectedColor === "orange"
          ? "template-home_page-orange"
          : selectedColor === "teal"
          ? "template-home_page-teal"
          : selectedColor === "cyan"
          ? "template-home_page-cyan"
          : selectedColor === "gray"
          ? "template-home_page-gray"
          : ""
      }
    >
      <div
        className={
          selectedFont === "arial"
            ...
            : selectedFont === "math"
            ? "template-font-10"
            : selectedFont === "lucida-handwriting"
            ? "template-font-11"
      ...
      >
        <div className="template-homepage_header">
          ...
          <Link className="account_txt" to="/Signup">
            Account
          </Link>
        </div>
        ...
        <div className="template-homepage_body">
          <div className="home_body_top">
              ...
              <Image
                ...
                src={
                  selectedColor === "blue"
                    ...
                    : selectedColor === "pink"
                    ? "/images/template-home-pink.svg"
                    : selectedColor === "purple"
                    ? "/images/template-home-purple.svg"
                    : selectedColor === "orange"
                    ? "/images/template-home-orange.svg"
                    : selectedColor === "teal"
                    ? "/images/template-home-teal.svg"
                    : selectedColor === "cyan"
                    ? "/images/template-home-cyan.svg"
                    : selectedColor === "gray"
                    ? "/images/template-home-gray.svg"
                    : ""
                }
              />
            </div>
            <div className="home_store_txt">
              ...
              <Text classname="store_descriprion">
                Store Name Store Name Store Name Store Name Store Name Store
                Name Store Name Store Name Store Name Store Name Store Name
                Store Name Store Name Store Name Store Name Store Name Store
                Name Store Name Store Name Store Name Store Name Store Name
